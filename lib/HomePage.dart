          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                InkWell(
                  onTap: (){
                    Navigator.of(context).pushNamed('fvr');
                  },
                  child: Icon(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          Navigator.of(context).pushNamed('isp');
                        },
                        child: Container(
                            height: h / 6,
                            width: w / 2.3,
                            child: ClipRRect(
                                ...
                                child: Image(
                                  image:
                                      AssetImage("assets/myimages/inspi.png"),
                                  fit: BoxFit.contain,
                                ))),
                      ),
                      Text(
                      ...
                      InkWell(
                        ...
                        child: Container(
                            ...
                            child: ClipRRect(
                                borderRadius: BorderRadius.circular(10),
                                child: Image(
                                  image: AssetImage("assets/myimages/love.png"),
                                  fit: BoxFit.contain,
                                ))),
                      ),
                    ...
                    children: [
                      Container(
                          ...
                          child: ClipRRect(
                              ...
                              child: Image(
                                image:
                                    AssetImage("assets/myimages/positive.png"),
                                fit: BoxFit.contain,
                              ))),
                      Text(
                        "Positive Qutes",
                    ...
                    children: [
                      Container(
                          ...
                          child: ClipRRect(
                              ...
                              child: Image(
                                image:
                                    AssetImage("assets/myimages/success.png"),
                                fit: BoxFit.contain,
                              ))),
                      Padding(padding: EdgeInsets.all(4)),
                      Text(
